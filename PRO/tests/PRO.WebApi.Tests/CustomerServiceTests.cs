...
public class CustomerServiceTests : IDisposable
{
    ...
    private void SeedData()
    {
        ...
        _dbContext.Customers.AddRange(
            new Customer
            {
                Id = 1, Name = "测试客户A", CustomerNo = "K2026010100020001",
                CustomerType = CustomerType.Major, Phone = "13800001111",
                Address = "北京市朝阳区", BranchId = 1,
                Status = CustomerStatus.Active, CreatedAt = DateTime.Now
            },
            new Customer
            {
                Id = 2, Name = "测试客户B", CustomerNo = "K2026010100020002",
                CustomerType = CustomerType.Sub, Phone = "13800002222",
                Address = "北京市海淀区", BranchId = 1,
                Status = CustomerStatus.Active, CreatedAt = DateTime.Now
            },
            new Customer
            {
                Id = 3, Name = "已删除客户", CustomerNo = "K2026010100020003",
                CustomerType = CustomerType.Major, Phone = "13800003333",
                BranchId = 1, Status = CustomerStatus.Deleted, CreatedAt = DateTime.Now
            }
        );
